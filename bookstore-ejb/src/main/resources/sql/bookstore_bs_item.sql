...
--
-- Table structure for table `bs_item`
--
...
--
-- Dumping data for table `bs_item`
--

LOCK TABLES `bs_item` WRITE;
/*!40000 ALTER TABLE `bs_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `bs_item` ENABLE KEYS */;
UNLOCK TABLES;
